 ...
 * Persists choice via localStorage and updates document element attribute
 */

(function initTheme() {
  const savedTheme = localStorage.getItem('jawad_theme');
  // Par défaut : thème clair, sobre et haute lisibilité
  if (savedTheme === 'dark') {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeToggleBtn.addEventListener('click', () => {
    ...
    localStorage.setItem('jawad_theme', newTheme);
    updateToggleIcon();
  });
});
